...
{           
	...
	DAC1CONL = 0xA208; //CMPPOL Non Inverted; HYSPOL Rising Edge; HYSSEL None; DACEN enabled; FLTREN disabled; CBE disabled; IRQM Rising edge detect; INSEL CMP1B; DACOEN enabled; 
